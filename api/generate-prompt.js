    ...
    try {
        const payload = {
            contents: [
                {
                    parts: [
                        { text: 'Generate one single, very creative and unique image generation prompt. The prompt should be for restyling a photo of a person. It should be weird, silly, and random. It should describe a style based on realistic materials, (digital) art styles, or funny combinations. Do not use generic words like "portrait" or "image".' }
                    ]
                }
            ]
        };
